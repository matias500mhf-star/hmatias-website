...
(() => {
  ...
  const addSmartServiceRouter = () => {
    ...
    inner.innerHTML = isEn
      ? '<h3>Not sure which HMATIAS service fits your requirement?</h3><p>Choose the closest need, or use Smart RFQ to turn a construction, maintenance or procurement requirement into a structured commercial brief.</p><div class="smart-route-actions"><a href="construction.html" data-smart-route="construction">Construction & remodeling</a><a href="facilities-en.html" data-smart-route="facilities">Maintenance & facilities</a><a href="supply-en.html" data-smart-route="supply">Supply & procurement</a><a href="business-services.html" data-smart-route="business_services">Business support</a><a href="rfq-en.html" data-smart-route="smart_rfq">Build a Smart RFQ →</a></div>'
      : '<h3>Não sabe qual área da HMATIAS corresponde à sua necessidade?</h3><p>Escolha o tipo de necessidade mais próximo ou use o Smart RFQ para transformar uma necessidade de obra, manutenção ou procurement num briefing comercial estruturado.</p><div class="smart-route-actions"><a href="construcao.html" data-smart-route="construction">Construção & remodelação</a><a href="facilities.html" data-smart-route="facilities">Manutenção & facilities</a><a href="supply.html" data-smart-route="supply">Supply & procurement</a><a href="servicos-administrativos.html" data-smart-route="business_services">Apoio empresarial</a><a href="rfq.html" data-smart-route="smart_rfq">Preparar Smart RFQ →</a></div>';
