...
if(!document.querySelector('script[data-hmatias-assistant]')){const a=document.createElement('script');a.src='assistant.js?v=2';a.defer=true;a.dataset.hmatiasAssistant='true';document.head.appendChild(a);}
