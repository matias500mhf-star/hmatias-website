...
if(!document.querySelector('link[data-hmatias-premium]')){const p=document.createElement('link');p.rel='stylesheet';p.href='premium.css?v=3';p.dataset.hmatiasPremium='true';document.head.appendChild(p);}
