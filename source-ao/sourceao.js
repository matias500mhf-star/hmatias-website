(()=>{
  ...
  const dictionary={
    en:{
      ...
      navSearch:'Search',navRadar:'Radar',navHow:'How it works',angolaFirst:'Angola-first',navRequest:'Start sourcing',
    ...
    pt:{
      ...
      navSearch:'Pesquisa',navRadar:'Radar',navHow:'Como funciona',angolaFirst:'Angola-first',navRequest:'Iniciar sourcing',
